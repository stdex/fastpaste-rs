...
options-security-warning-forgotten = There is no way to recover a forgotten passphrase.
...
options-security-remember-needs-current = Type your current passphrase first.
options-security-remember-failed = Could not save the passphrase to the system keyring.
options-security-remember-done = Passphrase remembered.
options-security-forget-failed = Could not remove the saved passphrase.
options-security-forget-done = The saved passphrase was removed.
